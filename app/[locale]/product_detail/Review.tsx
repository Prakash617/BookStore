import BlackButton from "@/components/Layout/Button/BlackButton";
    ...
    <>
      <div className="py-12  px-4 md:px-6 2xl:px-0 2xl:container 2xl:mx-auto flex justify-center items-center">
        <div className="flex flex-col justify-start items-start w-full space-y-8">
          ...
          <div>
            <p className="text-xl my-4 lg:text-2xl font-semibold leading-7 lg:leading-9 text-gray-500">
              How would you rate this book?
            </p>
            
            <Dialog>
              <DialogTrigger>
              {/* <button className="bg-gray-900 dark:bg-gray-600 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700">Add Review</button> */}
<BlackButton text={"Add Review"} />
              </DialogTrigger>
              <DialogContent>
                <Rating />
              </DialogContent>
