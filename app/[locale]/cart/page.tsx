...
const Cart = (props: Props) => {
  return (
    <>
        <section
        className=" relative mt-8 after:contents-[''] after:absolute after:z-0 after:h-full xl:after:w-1/3 after:top-0 after:right-0 ">
            ...
            <div className="grid grid-cols-12">
                <div
                    ...
                    <div className="flex items-center justify-between pb-8 border-b border-gray-300">
                        ...
                        <h2 className="font-manrope font-bold text-3xl leading-10 text-black">3 Items</h2>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 w-full">
                            <div className="md:col-span-2">
                                <div className="flex flex-col max-[500px]:items-center gap-3">
                                    ...
                                    <h6 className="font-semibold text-base leading-7 text-indigo-600">$120.00</h6>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                                <p className="font-bold text-lg leading-8 text-indigo-600 text-center">$120.00</p>
                            </div>
                        </div>
                    </div>
                    <div
                ...
                <div
                    className=" col-span-12 xl:col-span-4 bg-gray-50 w-full max-xl:px-6 max-w-3xl xl:max-w-lg mx-auto lg:px-8 py-24">
